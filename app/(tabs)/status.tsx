...
const STATUSES: StatusItem[] = [
  { id: '1', name: 'Dilshan Singh', time: '10 minutes ago',  viewed: false, avatar: 'https://i.pravatar.cc/150?img=3' },
  { id: '2', name: 'Franklin',      time: '25 minutes ago',  viewed: false, avatar: 'https://i.pravatar.cc/150?img=5' },
  { id: '3', name: 'Mom',           time: '1 hour ago',      viewed: true,  avatar: 'https://i.pravatar.cc/150?img=4' },
  { id: '4', name: 'Rishav',        time: '2 hours ago',     viewed: true,  avatar: 'https://i.pravatar.cc/150?img=8' },
  { id: '5', name: 'Bhupinder',     time: '4 hours ago',     viewed: true,  avatar: 'https://i.pravatar.cc/150?img=10'},
];
...
export default function StatusScreen() {
  ...
  const renderStatus = ({ item }: { item: StatusItem }) => (
    <TouchableOpacity
      style={[styles.statusRow, { backgroundColor: colors.surface, borderBottomColor: colors.border }]}
      activeOpacity={0.7}
    >
      {/* Ring around avatar */}
      <View
      ...
      <MaterialCommunityIcons name="dots-vertical" size={20} color={colors.iconMuted} />
    </TouchableOpacity>
  );
  ...
  return (
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      ...
      <ScrollView>
        {/* My Status */}
        <TouchableOpacity
          style={[styles.myStatus, { backgroundColor: colors.surface, borderBottomColor: colors.border }]}
          activeOpacity={0.7}
        >
          ...
          <MaterialCommunityIcons name="camera-outline" size={22} color={colors.iconMuted} style={{ marginRight: 10 }} />
          <MaterialCommunityIcons name="pencil-outline" size={22} color={colors.iconMuted} />
        </TouchableOpacity>
